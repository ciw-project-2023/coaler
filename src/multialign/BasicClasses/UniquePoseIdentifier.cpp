...
namespace coaler::multialign {
    ...
    UniquePoseIdentifier::UniquePoseIdentifier(LigandID ligandId, PoseID ligandInternalPoseId)
    ...
    bool UniquePoseIdentifier::operator!=(const UniquePoseIdentifier &other) const { return !(*this == other); }
    ...
    LigandID UniquePoseIdentifier::getLigandId() const { return m_ligandId; }

    /*----------------------------------------------------------------------------------------------------------------*/

    PoseID UniquePoseIdentifier::getLigandInternalPoseId() const { return m_ligandInternalPoseId; }
