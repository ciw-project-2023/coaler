...
namespace MultiAlign
{
    ...
    bool LigandPair::operator==(const LigandPair &other) const {
        return this->m_firstLigand == other.m_firstLigand
               && this->m_secondLigand == other.m_secondLigand;
    }

    /*----------------------------------------------------------------------------------------------------------------*/

    LigandID LigandPair::getFirst() const noexcept {
        return m_firstLigand;
    }

    /*----------------------------------------------------------------------------------------------------------------*/

    LigandID LigandPair::getSecond() const noexcept {
        return m_secondLigand;
    }
}
